...
const historicTrades_1 = require("./historicTrades");
...
const cryptoClient = (apiKey, apiBase = "https://api.polygon.io") => ({
    aggregates: (0, request_1.auth)(apiKey, aggregates_1.aggregates, apiBase),
    ...
    historicTrades: (0, request_1.auth)(apiKey, historicTrades_1.historicTrades, apiBase),
