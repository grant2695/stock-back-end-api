...
const stockDividends = (apiKey, apiBase, symbol) => __awaiter(void 0, void 0, void 0, function* () { return (0, request_1.get)(`/v2/reference/dividends/${symbol}`, apiKey, apiBase); });
